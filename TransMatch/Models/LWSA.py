...
class LWSA(nn.Module):
    def __init__(self, config):
        ...
        self.c1 = Conv3dReLU.Conv3dReLU(args.input_channel // 2, embed_dim//2, 3, 1, use_batchnorm=False)
        self.c2 = Conv3dReLU.Conv3dReLU(args.input_channel // 2, config.reg_head_chan, 3, 1, use_batchnorm=False)
